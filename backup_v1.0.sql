...
CREATE TABLE products (
  ...
  name TEXT NOT NULL,
  status TEXT NOT NULL DEFAULT 'active',
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, company_id INTEGER, category_id INTEGER REFERENCES categories(id), type TEXT NOT NULL DEFAULT 'finished_good', base_unit TEXT NOT NULL DEFAULT 'u', cost REAL NOT NULL DEFAULT 0, price REAL NOT NULL DEFAULT 0,
  FOREIGN KEY (business_line_id) REFERENCES business_lines(id),
  FOREIGN KEY (store_id) REFERENCES stores(id)
);
INSERT INTO "products" ("id","business_line_id","store_id","code","name","status","created_at","company_id","category_id","type","base_unit","cost","price") VALUES(1,1,1,'ING-HAR','Harina de Trigo (Saco 25kg)','active','2026-08-07 11:57:21',1,NULL,'finished_good','u',0,0);
INSERT INTO "products" ("id","business_line_id","store_id","code","name","status","created_at","company_id","category_id","type","base_unit","cost","price") VALUES(2,1,1,'ING-MAN','Mantequilla (Bloque 5kg)','active','2026-08-07 11:57:21',1,NULL,'finished_good','u',0,0);
INSERT INTO "products" ("id","business_line_id","store_id","code","name","status","created_at","company_id","category_id","type","base_unit","cost","price") VALUES(3,1,1,'ING-SAL','Sal fina (Kg)','active','2026-08-07 11:57:21',1,NULL,'finished_good','u',0,0);
INSERT INTO "products" ("id","business_line_id","store_id","code","name","status","created_at","company_id","category_id","type","base_unit","cost","price") VALUES(4,1,1,'PROD-CRO','Croissant Artesano','active','2026-08-07 11:57:21',1,NULL,'finished_good','u',0,0);
INSERT INTO "products" ("id","business_line_id","store_id","code","name","status","created_at","company_id","category_id","type","base_unit","cost","price") VALUES(5,1,1,'PROD-PAN','Pan de Masa Madre','active','2026-08-07 11:57:21',1,NULL,'finished_good','u',0,0);
...
CREATE TABLE production_orders (
  ...
  started_at TEXT,
  completed_at TEXT,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, company_id INTEGER, actual_quantity INTEGER NOT NULL DEFAULT 0,
  FOREIGN KEY (store_id) REFERENCES stores(id),
  FOREIGN KEY (business_line_id) REFERENCES business_lines(id)
);
INSERT INTO "production_orders" ("id","store_id","business_line_id","status","target_quantity","started_at","completed_at","created_at","company_id","actual_quantity") VALUES(1,1,1,'in_progress',100,NULL,NULL,'2026-08-07 11:57:22',1,0);
...
INSERT INTO "users" ("id","company_id","email","password_hash","password_salt","role","status","created_at","must_change_password") VALUES(2,1,'eyestaff.ncarrillo@gmail.com','f69ed0029e96fbc283b8dde44098347308bf99c82211063556093373914a0764','1ac8fa733c5d7af02fd4e58abf7c2920','admin','active','2026-08-07 17:51:50',0);
...
INSERT INTO "sessions" ("id","user_id","token","expires_at","created_at") VALUES(23,2,'786608de68dfef3a5b63f6549e56e737e848a57766d0d1c89b19e4548f3bfa7f',1786877540813,'2026-08-09 10:52:20');
INSERT INTO "sessions" ("id","user_id","token","expires_at","created_at") VALUES(24,2,'89cf748d5009cf4816ab354116e9a538d4c95d21a0b98832ef3dc72becab76ff',1786877568035,'2026-08-09 10:52:48');
INSERT INTO "sessions" ("id","user_id","token","expires_at","created_at") VALUES(26,2,'6d2ee183c822dccb28fa2eb6cbc68139def10fb362cff3163e95d4cd7dd4afce',1786891326476,'2026-08-09 14:42:06');
INSERT INTO "sessions" ("id","user_id","token","expires_at","created_at") VALUES(27,2,'d63da5ba758bd0b821a432c662e47bd74b848f05b5849feb4704f65c4ec89914',1786912317689,'2026-08-09 20:31:57');
INSERT INTO "sessions" ("id","user_id","token","expires_at","created_at") VALUES(28,2,'f5fabc2d954943a3b68fa305254609de54a1880cfdf814676da94db4dd2ff3b2',1786988773764,'2026-08-10 17:46:13');
...
INSERT INTO "password_reset_tokens" ("id","user_id","token_hash","expires_at","used_at","created_at") VALUES(2,2,'61add420c0c2e7bbcd6f78ef2c410dc579088329a84884c3c81e8e4ce74d8cf2',1786274514534,1786272734700,'2026-08-09 10:51:54');
...
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('sessions',28);
...
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('password_reset_tokens',2);
