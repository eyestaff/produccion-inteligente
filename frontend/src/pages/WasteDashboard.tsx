        ...
        <>
          ...
          <div className="kpi-grid animate-in animate-delay-1">
            <article className="kpi-card" style={{ borderLeft: '4px solid #ef4444' }}>
              ...
              <strong className="kpi-value" style={{ color: '#ef4444' }}>
                {metrics?.dailyWaste || 0}
              </strong>
            ...
            <article className="kpi-card">
              ...
              <strong className="kpi-value" style={{ fontSize: '1.5rem' }}>
                {metrics?.topProduct || '-'}
              </strong>
              <p className="kpi-detail" style={{ color: '#ef4444' }}>
                {metrics?.topProductWaste || 0} unidades mermadas
              </p>
            </article>
            ...
            <article className="kpi-card" style={{ borderLeft: '4px solid #f59e0b' }}>
              ...
              <strong className="kpi-value" style={{ color: '#f59e0b' }}>
                ${(metrics?.estimatedCost || 0).toFixed(2)}
              </strong>
