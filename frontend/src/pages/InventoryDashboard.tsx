    ...
    >
      ...
      <div className="kpi-grid animate-in animate-delay-1">
        ...
        <article className="kpi-card">
          ...
          <strong
            className="kpi-value"
            style={{ color: kpis.lowStock > 0 ? '#ef4444' : 'inherit' }}
          >
            {kpis.lowStock}
          </strong>
        </article>
      ...
      <div className="card animate-in animate-delay-2" style={{ padding: 0, overflow: 'hidden' }}>
        <div
          ...
          style={{ padding: '1.25rem', borderBottom: '1px solid var(--border)' }}
        >
                    ...
                    <td colSpan={5}>
                      <div style={{ padding: '2rem' }}>
                        <EmptyState
                          ...
                          description="No se encontraron productos en esta vista."
                        />
                      </div>
                    </td>
                  </tr>
                  ...
                  filteredInventory.map((item) => (
                    <tr key={item.productId}>
                      ...
                      <td
                        ...
                        style={{
                          fontWeight: 700,
                          color: item.availableQuantity <= 0 ? '#ef4444' : 'inherit',
                        }}
                      >
                        {item.availableQuantity}
                      </td>
                      <td className="text-center">
                        <button
                          onClick={() =>
                            navigate(`/inventory/${selectedStoreId}/product/${item.productId}`, {
